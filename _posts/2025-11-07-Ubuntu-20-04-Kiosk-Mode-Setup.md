...
- **[步骤 1：系统准备与更新](#step-1)**
- **[步骤 2：安装必要组件](#step-2)**
- **[步骤 3：创建 Kiosk 用户](#step-3)**
- **[步骤 4：配置 Openbox Kiosk 会话](#step-4)**
- **[步骤 5：创建 Openbox 会话入口](#step-5)**
- **[步骤 6：配置 LightDM 自动登录](#step-6)**
- **[步骤 7：配置会话切换](#step-7)**
- **[步骤 8：测试和验证](#step-8)**
